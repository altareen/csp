...
----------- | --------- | ---------
`Python` Source Code for Note Frequency | 1.3KB | [pset03.zip](/csp/zip/pset03.zip)
...
## Submission
+ Upload the file `notefrequency.py` to the [Web-CAT](http://ec2-54-65-207-33.ap-northeast-1.compute.amazonaws.com:8080/Web-CAT/WebObjects/Web-CAT.woa) automated grading platform.
